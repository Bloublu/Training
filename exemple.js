...
let txCitation = document.getElementById('citation');
let auteurCitation = document.getElementById('auteur');
let btn = document.getElementById('nouveau');
let btndebut = document.getElementById('debut');

var suivant = 0;
txCitation.textContent = citations[suivant][0];
auteurCitation.textContent = citations[suivant][1]
